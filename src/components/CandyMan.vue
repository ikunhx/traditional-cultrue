...
<template>
  <div>
    <div v-if="showConfirm" class="box2">
      <h1 class="title">真的要卸载吗？</h1>
      <div class="face">
        <div class="eyeBox">
          <div class="eye-container">
      ...
      <button class="no" @click="cancelClose">取消</button>
      <button class="yes" @click="confirmClose">确认</button>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    setupEventListeners() {
      const box2 = this.$el.querySelector(".box2");
      if (!box2) return;
