      ...
      if (user.account === "") {
        ...
        axios
          ...
          .then((response) => {
            ...
            // this.$store.dispatch("setAge", response.data.age);
            // this.$store.dispatch("setHobbit", response.data.hobbit);
            // this.$store.dispatch("setPhone", response.data.phone);
            // this.$store.dispatch("setAvatarImageUrl", response.data.avtar);
            // this.$store.dispatch("setMotto", response.data.motto);
